...
let background = "#0e1415"
let foreground = "#cecece"
let cursor     = "#cecece"

" ANSI Colors (alabaster palette)
let black      = "#000000"    " ansi 0 - black
let red        = "#d2322d"    " ansi 1 - red (errors, functions)
let green      = "#6abf40"    " ansi 2 - green (strings, added)
let yellow     = "#cd974b"    " ansi 3 - yellow (types, warnings, active)
let blue       = "#217EBC"    " ansi 4 - blue (keywords, definitions)
let magenta    = "#9B3596"    " ansi 5 - magenta (constants)
let cyan       = "#178F79"    " ansi 6 - cyan (special)
let white      = "#cecece"    " ansi 7 - foreground
let br_black   = "#333333"    " ansi 8 - bright black (comments dim)
let br_red     = "#c33c33"    " ansi 9 - bright red
let br_green   = "#95cb82"    " ansi 10 - bright green (strings)
let br_yellow  = "#dfdf8e"    " ansi 11 - bright yellow (comments)
let br_blue    = "#71aed7"    " ansi 12 - bright blue (definitions)
let br_magenta = "#cc8bc9"    " ansi 13 - bright magenta (constants)
let br_cyan    = "#47BEA9"    " ansi 14 - bright cyan
...
exe "hi Boolean guifg=" . white . " ctermfg=1"
exe "hi Constant guifg=" . br_magenta . " ctermfg=5"
exe "hi Identifier guifg=" . white . " ctermfg=7"
exe "hi Function guifg=" . white . " gui=bold ctermfg=1 cterm=bold"
...
exe "hi Keyword guifg=" . white . " gui=bold ctermfg=4 cterm=bold"
...
exe "hi Method guifg=" . white . " ctermfg=1"
...
exe "hi @variable guifg=" . white . " ctermfg=7"
exe "hi @variable.builtin guifg=" . br_magenta . " gui=italic ctermfg=5 cterm=italic"
exe "hi @variable.parameter guifg=" . white . " gui=italic ctermfg=7 cterm=italic"
exe "hi @constant guifg=" . br_magenta . " gui=bold ctermfg=5 cterm=bold"
exe "hi @constant.builtin guifg=" . br_magenta . " gui=bold,italic ctermfg=5 cterm=bold,italic"
...
exe "hi @character guifg=" . br_green . " ctermfg=10"
exe "hi @number guifg=" . cyan . " ctermfg=6"
exe "hi @boolean guifg=" . white . " gui=bold ctermfg=1 cterm=bold"
exe "hi @float guifg=" . cyan . " ctermfg=6"
exe "hi @function guifg=" . white . " gui=bold ctermfg=1 cterm=bold"
exe "hi @function.builtin guifg=" . white . " gui=bold,italic ctermfg=1 cterm=bold,italic"
exe "hi @function.macro guifg=" . white . " gui=bold ctermfg=9 cterm=bold"
exe "hi @method guifg=" . white . " ctermfg=1"
...
exe "hi @keyword guifg=" . white . " gui=bold ctermfg=4 cterm=bold"
exe "hi @keyword.function guifg=" . white . " gui=italic ctermfg=4 cterm=italic"
exe "hi @keyword.operator guifg=" . white . " ctermfg=4"
exe "hi @keyword.return guifg=" . white . " gui=bold ctermfg=4 cterm=bold"
exe "hi @conditional guifg=" . white . " ctermfg=4"
exe "hi @repeat guifg=" . blue . " ctermfg=4"
exe "hi @label guifg=" . blue . " ctermfg=4"
exe "hi @operator guifg=" . white . " ctermfg=7"
...
exe "hi @comment guifg=" . br_yellow . " gui=italic ctermfg=8 cterm=italic"
