...
theme.loadSyntax = function()
	...
	-- Italic comments
	if vim.g.minimalist_bold == true then
		syntax.Conditional = { fg = co.standout, bg = co.none, style = "bold" } -- bold if, then, else, endif, switch, etc.
		syntax.Keyword = { fg = co.standout, bg = co.none, style = "bold" } -- bold for, do, while, etc.
		syntax.Repeat = { fg = co.standout, bg = co.none, style = "bold" } -- bold any other keyword
		syntax.Comment = { fg = co.bg_2, bg = co.none, style = "bold" } -- bold comments
		syntax.Function = { fg = co.standout_less, bg = co.none, style = "bold" } -- bold funtion names
		syntax.Identifier = { fg = co.standout_less, bg = co.none, style = "bold" } -- any variable name
		syntax.String = { fg = co.standout_more, bg = co.none, style = "bold" } -- any string
	else
...
theme.loadEditor = function()
	...
	if vim.g.minimalist_disable_background == true then
	...
	if vim.g.minimalist_borders == true then
